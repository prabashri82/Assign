...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Dropdown(
           ...
           # style={'width:80%','padding:30px','fontsize:20px','textAlign:center'}
        )
    ]),
...
# Plot 2 Total Monthly Automobile sales using line chart.
  ...
  # Plot bar chart for average number of vehicles sold during the given year
    ...
    # Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph( figure=px.pie(exp_data,values = 'Vehicle_Type',title='Total Advertisment Expenditure for Each Vehicle'))
